...
# -----data related-----
data_root = 'your/path'  # Root path of data
# Path of train annotation file
train_ann_file = 'your/path'
train_data_prefix = ''  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'your/path'
...
anchors = [
    [(9, 19), (24, 11), (17, 39)],  # P3/8
    [(45, 18), (50, 50), (62, 130)],  # P4/16
    [(145, 146), (371, 204), (276, 378)]  # P5/32
]
...
save_epoch_intervals = 30  # Save model checkpoint and validation intervals

max_keep_ckpts = 4  # The maximum checkpoints to keep.
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        filter_cfg=dict(filter_empty_gt=True, min_size=1, bbox_min_size=1),
