...
--fuse-conv-bn
--work-dir
tools/work-dirs/DIOR/yolox-small/C5M6od4-fusion13Yolox-78.4/
...
--fuse-conv-bn
--work-dir
tools/work-dirs/DIOR/yolov7-tiny/C5M6od4-fusion13Yolo-77.1/

configs/yolox/yolox_s_DIOR.py
tools/work-dirs/DIOR/yolox-small/baseline-16*4-Ir0.01/best_coco_bbox_mAP_epoch_300.pth
--fuse-conv-bn
--work-dir
tools/work-dirs/DIOR/yolox-small/baseline-16*4-Ir0.01/
...
def measure_inference_speed(cfg, checkpoint, max_iter, log_interval,
    ...
    dataloader_cfg['num_workers'] = 0  # 默认0
    dataloader_cfg['batch_size'] = 1  # 默认1
    dataloader_cfg['persistent_workers'] = False  # 默认False
    ...
    for i, data in enumerate(data_loader):
        ...
        if i >= num_warmup:
            ...
            if (i + 1) % log_interval == 0:
                ...
                # fps = (i + 1 - num_warmup) * dataloader_cfg['batch_size'] / pure_inf_time
                print_log(
